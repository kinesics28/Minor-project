...
def meetLogin(mail_address,password):

    Glogin(mail_address, password)

    meetLink='https://meet.google.com/iqv-icbu-xbg'
    driver.get(meetLink)
...
def mic():
    driver.find_element_by_xpath(
        '//*[@id="ow3"]/div[1]/div/div[9]/div[3]/div[10]/div[2]/div/div[1]/div/div/span/button').click()
    driver.implicitly_wait(3000)


def video():
    driver.find_element_by_xpath(
        '//*[@id="ow3"]/div[1]/div/div[9]/div[3]/div[10]/div[2]/div/div[2]/div/span/button').click()
    driver.implicitly_wait(3000)


def openChat():
    driver.find_element_by_xpath(
        '//*[@id="ow3"]/div[1]/div/div[9]/div[3]/div[10]/div[3]/div[3]/div/div/div[3]/span/button').click()
    driver.implicitly_wait(3000)


def paste(x):
    message=driver.find_element_by_xpath('//*[@id="bfTqV"]')
    message.send_keys(x)
...
def send():
    driver.find_element_by_xpath('//*[@id="ow3"]/div[1]/div/div[9]/div[3]/div[4]/div[2]/div[2]/div/div[5]/span').click()
    driver.implicitly_wait(3000)

def closeChat():
    time.sleep(2)
    driver.find_element_by_xpath('//*[@id="ow3"]/div[1]/div/div[9]/div[3]/div[4]/div[2]/div[1]/div[2]/div/span/button').click()
    driver.implicitly_wait(3000)
